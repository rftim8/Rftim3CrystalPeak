...
{
    public class _RUSHHOUR : I_RUSHHOUR
    {
        #region Static
        ...
        public _RUSHHOUR()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_RUSHHOUR));
        }
        ...
        public _RUSHHOUR(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_RUSHHOUR));
        }
