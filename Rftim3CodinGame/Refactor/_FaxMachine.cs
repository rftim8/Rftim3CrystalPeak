...
{
    public class _FaxMachine : I_FaxMachine
    {
        #region Static
        ...
        public _FaxMachine()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_FaxMachine));
        }
        ...
        public _FaxMachine(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_FaxMachine));
        }
