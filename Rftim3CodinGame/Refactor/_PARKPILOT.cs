...
{
    public class _PARKPILOT : I_PARKPILOT
    {
        #region Static
        ...
        public _PARKPILOT()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_PARKPILOT));
        }
        ...
        public _PARKPILOT(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_PARKPILOT));
        }
