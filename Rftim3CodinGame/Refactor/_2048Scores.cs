...
{
    public class _2048Scores : I_2048Scores
    {
        #region Static
        ...
        public _2048Scores()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_2048Scores));
        }
        ...
        public _2048Scores(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_2048Scores));
        }
