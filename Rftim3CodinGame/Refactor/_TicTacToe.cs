...
{
    public class _TicTacToe : I_TicTacToe
    {
        #region Static
        ...
        public _TicTacToe()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TicTacToe));
        }
        ...
        public _TicTacToe(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TicTacToe));
        }
