...
{
    public class _InStereo : I_InStereo
    {
        #region Static
        ...
        public _InStereo()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_InStereo));
        }
        ...
        public _InStereo(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_InStereo));
        }
