...
{
    public class _CrazyList : I_CrazyList
    {
        #region Static
        ...
        public _CrazyList()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_CrazyList));
        }
        ...
        public _CrazyList(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_CrazyList));
        }
