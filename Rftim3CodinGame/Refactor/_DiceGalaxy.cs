...
{
    public class _DiceGalaxy : I_DiceGalaxy
    {
        #region Static
        ...
        public _DiceGalaxy()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_DiceGalaxy));
        }
        ...
        public _DiceGalaxy(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_DiceGalaxy));
        }
