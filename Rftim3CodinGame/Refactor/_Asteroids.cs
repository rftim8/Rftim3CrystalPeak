...
{
    public class _Asteroids : I_Asteroids
    {
        #region Static
        ...
        public _Asteroids()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Asteroids));
        }
        ...
        public _Asteroids(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Asteroids));
        }
