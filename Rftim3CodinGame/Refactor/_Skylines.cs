...
{
    public class _Skylines : I_Skylines
    {
        #region Static
        ...
        public _Skylines()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Skylines));
        }
        ...
        public _Skylines(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Skylines));
        }
