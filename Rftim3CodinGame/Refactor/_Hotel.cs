...
namespace Rftim3CodinGame.Refactor
{
    public class _Hotel : I_Hotel
    {
        ...
        public _Hotel()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Hotel));
        }
        ...
        public _Hotel(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Hotel));
        }
