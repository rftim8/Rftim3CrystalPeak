...
{
    public class _OneWayCity : I_OneWayCity
    {
        #region Static
        ...
        public _OneWayCity()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_OneWayCity));
        }
        ...
        public _OneWayCity(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_OneWayCity));
        }
