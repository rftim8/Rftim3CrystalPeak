...
namespace Rftim3CodinGame.Refactor
{
    public class _Buzzle : I_Buzzle
    {
        ...
        public _Buzzle()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Buzzle));
        }
        ...
        public _Buzzle(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Buzzle));
        }
