...
{
    public class _CosmicLove : I_CosmicLove
    {
        #region Static
        ...
        public _CosmicLove()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_CosmicLove));
        }
        ...
        public _CosmicLove(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_CosmicLove));
        }
