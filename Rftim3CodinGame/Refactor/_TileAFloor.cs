...
{
    public class _TileAFloor : I_TileAFloor
    {
        #region Static
        ...
        public _TileAFloor()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TileAFloor));
        }
        ...
        public _TileAFloor(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TileAFloor));
        }
