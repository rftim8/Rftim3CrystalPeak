...
namespace Rftim3CodinGame.Refactor
{
    public class _Vortex : I_Vortex
    {
        ...
        public _Vortex()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Vortex));
        }
        ...
        public _Vortex(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Vortex));
        }
