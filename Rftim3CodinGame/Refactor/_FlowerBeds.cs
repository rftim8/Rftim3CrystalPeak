...
{
    public class _FlowerBeds : I_FlowerBeds
    {
        #region Static
        ...
        public _FlowerBeds()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_FlowerBeds));
        }
        ...
        public _FlowerBeds(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_FlowerBeds));
        }
