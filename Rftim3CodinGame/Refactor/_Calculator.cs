...
{
    public class _Calculator : I_Calculator
    {
        #region Static
        ...
        public _Calculator()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Calculator));
        }
        ...
        public _Calculator(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Calculator));
        }
