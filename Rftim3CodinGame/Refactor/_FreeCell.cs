...
{
    public class _FreeCell : I_FreeCell
    {
        #region Static
        ...
        public _FreeCell()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_FreeCell));
        }
        ...
        public _FreeCell(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_FreeCell));
        }
