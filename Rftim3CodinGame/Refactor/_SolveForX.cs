...
{
    public class _SolveForX : I_SolveForX
    {
        #region Static
        ...
        public _SolveForX()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_SolveForX));
        }
        ...
        public _SolveForX(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_SolveForX));
        }
