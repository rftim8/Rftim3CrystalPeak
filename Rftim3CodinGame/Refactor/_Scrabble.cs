...
{
    public class _Scrabble : I_Scrabble
    {
        #region Static
        ...
        public _Scrabble()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Scrabble));
        }
        ...
        public _Scrabble(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Scrabble));
        }
