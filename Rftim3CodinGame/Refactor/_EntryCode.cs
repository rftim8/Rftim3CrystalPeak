...
{
    public class _EntryCode : I_EntryCode
    {
        #region Static
        ...
        public _EntryCode()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_EntryCode));
        }
        ...
        public _EntryCode(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_EntryCode));
        }
