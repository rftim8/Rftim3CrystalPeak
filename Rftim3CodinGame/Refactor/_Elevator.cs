...
{
    public class _Elevator : I_Elevator
    {
        #region Static
        ...
        public _Elevator()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Elevator));
        }
        ...
        public _Elevator(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Elevator));
        }
