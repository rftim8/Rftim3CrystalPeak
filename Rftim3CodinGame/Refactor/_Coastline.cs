...
{
    public class _Coastline : I_Coastline
    {
        #region Static
        ...
        public _Coastline()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Coastline));
        }
        ...
        public _Coastline(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Coastline));
        }
