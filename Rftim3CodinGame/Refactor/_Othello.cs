...
{
    public class _Othello : I_Othello
    {
        #region Static
        ...
        public _Othello()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Othello));
        }
        ...
        public _Othello(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Othello));
        }
