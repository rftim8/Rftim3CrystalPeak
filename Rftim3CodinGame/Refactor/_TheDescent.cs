...
{
    public class _TheDescent : I_TheDescent
    {
        #region Static
        ...
        public _TheDescent()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TheDescent));
        }
        ...
        public _TheDescent(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TheDescent));
        }
