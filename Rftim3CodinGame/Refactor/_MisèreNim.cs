...
{
    public class _MisèreNim : I_MisèreNim
    {
        #region Static
        ...
        public _MisèreNim()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_MisèreNim));
        }
        ...
        public _MisèreNim(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_MisèreNim));
        }
