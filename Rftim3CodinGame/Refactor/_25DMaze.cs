...
{
    public class _25DMaze : I_25DMaze
    {
        #region Static
        ...
        public _25DMaze()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_25DMaze));
        }
        ...
        public _25DMaze(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_25DMaze));
        }
