...
{
    public class _GhostLegs : I_GhostLegs
    {
        #region Static
        ...
        public _GhostLegs()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_GhostLegs));
        }
        ...
        public _GhostLegs(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_GhostLegs));
        }
