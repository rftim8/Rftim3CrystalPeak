...
{
    public class _TheDart101 : I_TheDart101
    {
        #region Static
        ...
        public _TheDart101()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TheDart101));
        }
        ...
        public _TheDart101(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TheDart101));
        }
