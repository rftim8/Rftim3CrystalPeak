...
{
    public class _BinPacking : I_BinPacking
    {
        #region Static
        ...
        public _BinPacking()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_BinPacking));
        }
        ...
        public _BinPacking(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_BinPacking));
        }
