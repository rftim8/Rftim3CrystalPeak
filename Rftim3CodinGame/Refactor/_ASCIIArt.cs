...
{
    public class _ASCIIArt : I_ASCIIArt
    {
        #region Static
        ...
        public _ASCIIArt()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_ASCIIArt));
        }
        ...
        public _ASCIIArt(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_ASCIIArt));
        }
