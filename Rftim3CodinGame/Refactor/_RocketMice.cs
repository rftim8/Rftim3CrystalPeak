...
{
    public class _RocketMice : I_RocketMice
    {
        #region Static
        ...
        public _RocketMice()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_RocketMice));
        }
        ...
        public _RocketMice(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_RocketMice));
        }
