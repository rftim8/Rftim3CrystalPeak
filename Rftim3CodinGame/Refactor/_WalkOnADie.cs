...
{
    public class _WalkOnADie : I_WalkOnADie
    {
        #region Static
        ...
        public _WalkOnADie()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_WalkOnADie));
        }
        ...
        public _WalkOnADie(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_WalkOnADie));
        }
