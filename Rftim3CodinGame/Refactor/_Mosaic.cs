...
namespace Rftim3CodinGame.Refactor
{
    public class _Mosaic : I_Mosaic
    {
        ...
        public _Mosaic()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Mosaic));
        }
        ...
        public _Mosaic(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Mosaic));
        }
