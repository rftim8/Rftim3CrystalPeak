...
{
    public class _HiddenWord : I_HiddenWord
    {
        #region Static
        ...
        public _HiddenWord()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_HiddenWord));
        }
        ...
        public _HiddenWord(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_HiddenWord));
        }
