...
{
    public class _AutoPickup : I_AutoPickup
    {
        #region Static
        ...
        public _AutoPickup()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_AutoPickup));
        }
        ...
        public _AutoPickup(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_AutoPickup));
        }
