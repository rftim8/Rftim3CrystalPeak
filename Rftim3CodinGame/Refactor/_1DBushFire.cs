...
{
    public class _1DBushFire : I_1DBushFire
    {
        #region Static
        ...
        public _1DBushFire()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_1DBushFire));
        }
        ...
        public _1DBushFire(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_1DBushFire));
        }
