...
{
    public class _RobotShow : I_RobotShow
    {
        #region Static
        ...
        public _RobotShow()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_RobotShow));
        }
        ...
        public _RobotShow(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_RobotShow));
        }
