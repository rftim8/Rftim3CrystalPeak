...
{
    public class _MaxRect : I_MaxRect
    {
        #region Static
        ...
        public _MaxRect()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_MaxRect));
        }
        ...
        public _MaxRect(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_MaxRect));
        }
