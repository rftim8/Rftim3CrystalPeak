...
{
    public class _TreePaths : I_TreePaths
    {
        #region Static
        ...
        public _TreePaths()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TreePaths));
        }
        ...
        public _TreePaths(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TreePaths));
        }
