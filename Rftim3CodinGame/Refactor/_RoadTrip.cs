...
{
    public class _RoadTrip : I_RoadTrip
    {
        #region Static
        ...
        public _RoadTrip()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_RoadTrip));
        }
        ...
        public _RoadTrip(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_RoadTrip));
        }
