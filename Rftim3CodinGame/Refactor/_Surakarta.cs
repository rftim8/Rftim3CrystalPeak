...
{
    public class _Surakarta : I_Surakarta
    {
        #region Static
        ...
        public _Surakarta()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Surakarta));
        }
        ...
        public _Surakarta(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Surakarta));
        }
