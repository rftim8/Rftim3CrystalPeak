...
{
    public class _SnailRun : I_SnailRun
    {
        #region Static
        ...
        public _SnailRun()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_SnailRun));
        }
        ...
        public _SnailRun(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_SnailRun));
        }
