...
{
    public class _PlagueJr : I_PlagueJr
    {
        #region Static
        ...
        public _PlagueJr()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_PlagueJr));
        }
        ...
        public _PlagueJr(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_PlagueJr));
        }
