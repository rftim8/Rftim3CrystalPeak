...
{
    public class _CatchingUp : I_CatchingUp
    {
        #region Static
        ...
        public _CatchingUp()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_CatchingUp));
        }
        ...
        public _CatchingUp(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_CatchingUp));
        }
