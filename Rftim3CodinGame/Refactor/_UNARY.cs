...
namespace Rftim3CodinGame.Refactor
{
    public class _UNARY : I_UNARY
    {
        ...
        public _UNARY()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_UNARY));
        }
        ...
        public _UNARY(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_UNARY));
        }
