...
{
    public class _MarkovAnts : I_MarkovAnts
    {
        #region Static
        ...
        public _MarkovAnts()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_MarkovAnts));
        }
        ...
        public _MarkovAnts(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_MarkovAnts));
        }
