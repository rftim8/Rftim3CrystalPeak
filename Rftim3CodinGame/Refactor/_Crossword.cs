...
{
    public class _Crossword : I_Crossword
    {
        #region Static
        ...
        public _Crossword()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Crossword));
        }
        ...
        public _Crossword(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Crossword));
        }
