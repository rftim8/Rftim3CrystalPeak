...
{
    public class _BloodTypes : I_BloodTypes
    {
        #region Static
        ...
        public _BloodTypes()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_BloodTypes));
        }
        ...
        public _BloodTypes(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_BloodTypes));
        }
