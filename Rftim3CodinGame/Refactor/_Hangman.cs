...
{
    public class _Hangman : I_Hangman
    {
        #region Static
        ...
        public _Hangman()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Hangman));
        }
        ...
        public _Hangman(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Hangman));
        }
