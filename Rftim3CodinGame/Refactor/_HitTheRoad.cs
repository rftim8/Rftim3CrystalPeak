...
{
    public class _HitTheRoad : I_HitTheRoad
    {
        #region Static
        ...
        public _HitTheRoad()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_HitTheRoad));
        }
        ...
        public _HitTheRoad(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_HitTheRoad));
        }
