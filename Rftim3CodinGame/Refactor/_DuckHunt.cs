...
{
    public class _DuckHunt : I_DuckHunt
    {
        #region Static
        ...
        public _DuckHunt()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_DuckHunt));
        }
        ...
        public _DuckHunt(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_DuckHunt));
        }
