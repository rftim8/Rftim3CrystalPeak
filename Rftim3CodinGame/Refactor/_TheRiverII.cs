...
{
    public class _TheRiverII : I_TheRiverII
    {
        #region Static
        ...
        public _TheRiverII()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TheRiverII));
        }
        ...
        public _TheRiverII(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TheRiverII));
        }
