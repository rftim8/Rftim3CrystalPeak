...
{
    public class _Sokoban : I_Sokoban
    {
        #region Static
        ...
        public _Sokoban()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Sokoban));
        }
        ...
        public _Sokoban(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Sokoban));
        }
