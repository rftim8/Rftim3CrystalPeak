...
namespace Rftim3CodinGame.Refactor
{
    public class _10101 : I_10101
    {
        ...
        public _10101()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_10101));
        }
        ...
        public _10101(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_10101));
        }
