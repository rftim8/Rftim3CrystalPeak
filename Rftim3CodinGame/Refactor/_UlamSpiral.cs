...
{
    public class _UlamSpiral : I_UlamSpiral
    {
        #region Static
        ...
        public _UlamSpiral()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_UlamSpiral));
        }
        ...
        public _UlamSpiral(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_UlamSpiral));
        }
