...
{
    public class _WallStreet : I_WallStreet
    {
        #region Static
        ...
        public _WallStreet()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_WallStreet));
        }
        ...
        public _WallStreet(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_WallStreet));
        }
