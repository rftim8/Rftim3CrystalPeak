...
{
    public class _HelloWorld : I_HelloWorld
    {
        #region Static
        ...
        public _HelloWorld()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_HelloWorld));
        }
        ...
        public _HelloWorld(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_HelloWorld));
        }
