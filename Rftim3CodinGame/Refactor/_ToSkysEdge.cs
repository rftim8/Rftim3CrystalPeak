...
{
    public class _ToSkysEdge : I_ToSkysEdge
    {
        #region Static
        ...
        public _ToSkysEdge()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_ToSkysEdge));
        }
        ...
        public _ToSkysEdge(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_ToSkysEdge));
        }
