...
{
    public class _Criminal : I_Criminal
    {
        #region Static
        ...
        public _Criminal()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Criminal));
        }
        ...
        public _Criminal(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Criminal));
        }
