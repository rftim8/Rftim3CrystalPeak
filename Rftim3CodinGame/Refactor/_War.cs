...
namespace Rftim3CodinGame.Refactor
{
    public class _War : I_War
    {
        ...
        public _War()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_War));
        }
        ...
        public _War(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_War));
        }
