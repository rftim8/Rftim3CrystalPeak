...
{
    public class _RobotReach : I_RobotReach
    {
        #region Static
        ...
        public _RobotReach()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_RobotReach));
        }
        ...
        public _RobotReach(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_RobotReach));
        }
