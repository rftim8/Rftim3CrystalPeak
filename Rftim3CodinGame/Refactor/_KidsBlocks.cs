...
{
    public class _KidsBlocks : I_KidsBlocks
    {
        #region Static
        ...
        public _KidsBlocks()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_KidsBlocks));
        }
        ...
        public _KidsBlocks(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_KidsBlocks));
        }
