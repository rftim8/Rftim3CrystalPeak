...
{
    public class _TheParking : I_TheParking
    {
        #region Static
        ...
        public _TheParking()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TheParking));
        }
        ...
        public _TheParking(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TheParking));
        }
