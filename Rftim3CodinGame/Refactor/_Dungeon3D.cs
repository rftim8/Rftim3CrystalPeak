...
{
    public class _Dungeon3D : I_Dungeon3D
    {
        #region Static
        ...
        public _Dungeon3D()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Dungeon3D));
        }
        ...
        public _Dungeon3D(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Dungeon3D));
        }
