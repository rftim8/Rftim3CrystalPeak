...
{
    public class _RandomWalk : I_RandomWalk
    {
        #region Static
        ...
        public _RandomWalk()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_RandomWalk));
        }
        ...
        public _RandomWalk(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_RandomWalk));
        }
