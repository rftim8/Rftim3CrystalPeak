...
{
    public class _TinyForest : I_TinyForest
    {
        #region Static
        ...
        public _TinyForest()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TinyForest));
        }
        ...
        public _TinyForest(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TinyForest));
        }
