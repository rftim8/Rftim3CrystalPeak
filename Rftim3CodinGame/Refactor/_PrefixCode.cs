...
{
    public class _PrefixCode : I_PrefixCode
    {
        #region Static
        ...
        public _PrefixCode()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_PrefixCode));
        }
        ...
        public _PrefixCode(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_PrefixCode));
        }
