...
{
    public class _AppleTree : I_AppleTree
    {
        #region Static
        ...
        public _AppleTree()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_AppleTree));
        }
        ...
        public _AppleTree(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_AppleTree));
        }
