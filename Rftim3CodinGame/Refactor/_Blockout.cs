...
{
    public class _Blockout : I_Blockout
    {
        #region Static
        ...
        public _Blockout()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Blockout));
        }
        ...
        public _Blockout(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Blockout));
        }
