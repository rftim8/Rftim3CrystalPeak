...
namespace Rftim3CodinGame.Refactor
{
    public class _KGood : I_KGood
    {
        ...
        public _KGood()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_KGood));
        }
        ...
        public _KGood(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_KGood));
        }
