...
namespace Rftim3CodinGame.Refactor
{
    public class _Tetris : I_Tetris
    {
        ...
        public _Tetris()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Tetris));
        }
        ...
        public _Tetris(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Tetris));
        }
