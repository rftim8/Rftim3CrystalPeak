...
{
    public class _Hourglass : I_Hourglass
    {
        #region Static
        ...
        public _Hourglass()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Hourglass));
        }
        ...
        public _Hourglass(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Hourglass));
        }
