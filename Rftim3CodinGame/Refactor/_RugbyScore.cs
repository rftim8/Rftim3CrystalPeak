...
{
    public class _RugbyScore : I_RugbyScore
    {
        #region Static
        ...
        public _RugbyScore()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_RugbyScore));
        }
        ...
        public _RugbyScore(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_RugbyScore));
        }
