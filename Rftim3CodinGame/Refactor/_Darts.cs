...
namespace Rftim3CodinGame.Refactor
{
    public class _Darts : I_Darts
    {
        ...
        public _Darts()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Darts));
        }
        ...
        public _Darts(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Darts));
        }
