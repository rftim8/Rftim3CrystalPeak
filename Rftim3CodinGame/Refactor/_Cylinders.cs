...
{
    public class _Cylinders : I_Cylinders
    {
        #region Static
        ...
        public _Cylinders()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Cylinders));
        }
        ...
        public _Cylinders(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Cylinders));
        }
