...
{
    public class _Mirrors : I_Mirrors
    {
        #region Static
        ...
        public _Mirrors()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Mirrors));
        }
        ...
        public _Mirrors(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Mirrors));
        }
