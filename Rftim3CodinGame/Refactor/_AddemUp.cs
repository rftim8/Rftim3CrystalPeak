...
{
    public class _AddemUp : I_AddemUp
    {
        #region Static
        ...
        public _AddemUp()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_AddemUp));
        }
        ...
        public _AddemUp(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_AddemUp));
        }
