...
{
    public class _LightBulbs : I_LightBulbs
    {
        #region Static
        ...
        public _LightBulbs()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_LightBulbs));
        }
        ...
        public _LightBulbs(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_LightBulbs));
        }
