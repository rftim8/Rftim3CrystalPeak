...
{
    public class _SpaceMaze : I_SpaceMaze
    {
        #region Static
        ...
        public _SpaceMaze()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_SpaceMaze));
        }
        ...
        public _SpaceMaze(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_SpaceMaze));
        }
