...
namespace Rftim3CodinGame.Refactor
{
    public class _Divine : I_Divine
    {
        ...
        public _Divine()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Divine));
        }
        ...
        public _Divine(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Divine));
        }
