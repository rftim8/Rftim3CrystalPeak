...
{
    public class _3NTiling : I_3NTiling
    {
        #region Static
        ...
        public _3NTiling()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_3NTiling));
        }
        ...
        public _3NTiling(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_3NTiling));
        }
