...
namespace Rftim3CodinGame.Refactor
{
    public class _Maze : I_Maze
    {
        ...
        public _Maze()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Maze));
        }
        ...
        public _Maze(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Maze));
        }
