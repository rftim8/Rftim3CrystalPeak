...
{
    public class _GameOfLife : I_GameOfLife
    {
        #region Static
        ...
        public _GameOfLife()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_GameOfLife));
        }
        ...
        public _GameOfLife(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_GameOfLife));
        }
