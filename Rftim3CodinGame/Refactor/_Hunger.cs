...
namespace Rftim3CodinGame.Refactor
{
    public class _Hunger : I_Hunger
    {
        ...
        public _Hunger()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Hunger));
        }
        ...
        public _Hunger(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Hunger));
        }
