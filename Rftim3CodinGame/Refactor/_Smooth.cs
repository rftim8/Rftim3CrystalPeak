...
namespace Rftim3CodinGame.Refactor
{
    public class _Smooth : I_Smooth
    {
        ...
        public _Smooth()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Smooth));
        }
        ...
        public _Smooth(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Smooth));
        }
