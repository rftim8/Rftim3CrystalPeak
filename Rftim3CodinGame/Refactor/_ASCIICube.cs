...
{
    public class _ASCIICube : I_ASCIICube
    {
        #region Static
        ...
        public _ASCIICube()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_ASCIICube));
        }
        ...
        public _ASCIICube(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_ASCIICube));
        }
