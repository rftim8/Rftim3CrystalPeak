...
{
    public class _ForestFire : I_ForestFire
    {
        #region Static
        ...
        public _ForestFire()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_ForestFire));
        }
        ...
        public _ForestFire(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_ForestFire));
        }
