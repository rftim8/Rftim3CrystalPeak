...
namespace Rftim3CodinGame.Refactor
{
    public class _24Game : I_24Game
    {
        ...
        public _24Game()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_24Game));
        }
        ...
        public _24Game(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_24Game));
        }
