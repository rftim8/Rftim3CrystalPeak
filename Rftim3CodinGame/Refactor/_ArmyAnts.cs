...
{
    public class _ArmyAnts : I_ArmyAnts
    {
        #region Static
        ...
        public _ArmyAnts()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_ArmyAnts));
        }
        ...
        public _ArmyAnts(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_ArmyAnts));
        }
