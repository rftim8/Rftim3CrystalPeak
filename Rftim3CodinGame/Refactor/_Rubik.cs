...
namespace Rftim3CodinGame.Refactor
{
    public class _Rubik : I_Rubik
    {
        ...
        public _Rubik()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Rubik));
        }
        ...
        public _Rubik(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Rubik));
        }
