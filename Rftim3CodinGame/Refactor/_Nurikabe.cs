...
{
    public class _Nurikabe : I_Nurikabe
    {
        #region Static
        ...
        public _Nurikabe()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Nurikabe));
        }
        ...
        public _Nurikabe(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Nurikabe));
        }
