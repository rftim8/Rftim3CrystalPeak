...
{
    public class _MIMEType : I_MIMEType
    {
        #region Static
        ...
        public _MIMEType()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_MIMEType));
        }
        ...
        public _MIMEType(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_MIMEType));
        }
