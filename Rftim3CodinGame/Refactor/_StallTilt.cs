...
{
    public class _StallTilt : I_StallTilt
    {
        #region Static
        ...
        public _StallTilt()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_StallTilt));
        }
        ...
        public _StallTilt(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_StallTilt));
        }
