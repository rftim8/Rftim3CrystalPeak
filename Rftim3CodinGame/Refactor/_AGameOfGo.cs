...
{
    public class _AGameOfGo : I_AGameOfGo
    {
        #region Static
        ...
        public _AGameOfGo()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_AGameOfGo));
        }
        ...
        public _AGameOfGo(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_AGameOfGo));
        }
