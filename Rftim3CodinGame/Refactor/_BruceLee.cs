...
{
    public class _BruceLee : I_BruceLee
    {
        #region Static
        ...
        public _BruceLee()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_BruceLee));
        }
        ...
        public _BruceLee(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_BruceLee));
        }
