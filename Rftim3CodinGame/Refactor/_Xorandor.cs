...
{
    public class _Xorandor : I_Xorandor
    {
        #region Static
        ...
        public _Xorandor()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Xorandor));
        }
        ...
        public _Xorandor(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Xorandor));
        }
