...
{
    public class _Candies : I_Candies
    {
        #region Static
        ...
        public _Candies()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Candies));
        }
        ...
        public _Candies(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Candies));
        }
