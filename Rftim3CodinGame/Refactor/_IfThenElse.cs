...
{
    public class _IfThenElse : I_IfThenElse
    {
        #region Static
        ...
        public _IfThenElse()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_IfThenElse));
        }
        ...
        public _IfThenElse(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_IfThenElse));
        }
