...
{
    public class _LogicGates : I_LogicGates
    {
        #region Static
        ...
        public _LogicGates()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_LogicGates));
        }
        ...
        public _LogicGates(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_LogicGates));
        }
