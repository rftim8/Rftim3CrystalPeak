...
{
    public class _Battleship : I_Battleship
    {
        #region Static
        ...
        public _Battleship()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Battleship));
        }
        ...
        public _Battleship(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Battleship));
        }
