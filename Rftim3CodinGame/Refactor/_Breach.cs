...
namespace Rftim3CodinGame.Refactor
{
    public class _Breach : I_Breach
    {
        ...
        public _Breach()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Breach));
        }
        ...
        public _Breach(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Breach));
        }
