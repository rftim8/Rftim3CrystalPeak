...
{
    public class _TheFastest : I_TheFastest
    {
        #region Static
        ...
        public _TheFastest()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TheFastest));
        }
        ...
        public _TheFastest(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TheFastest));
        }
