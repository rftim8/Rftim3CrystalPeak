...
{
    public class _SweetSpot : I_SweetSpot
    {
        #region Static
        ...
        public _SweetSpot()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_SweetSpot));
        }
        ...
        public _SweetSpot(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_SweetSpot));
        }
