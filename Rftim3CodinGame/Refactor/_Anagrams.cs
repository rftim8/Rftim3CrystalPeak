...
{
    public class _Anagrams : I_Anagrams
    {
        #region Static
        ...
        public _Anagrams()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Anagrams));
        }
        ...
        public _Anagrams(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Anagrams));
        }
