...
{
    public class _SimpleBlur : I_SimpleBlur
    {
        #region Static
        ...
        public _SimpleBlur()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_SimpleBlur));
        }
        ...
        public _SimpleBlur(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_SimpleBlur));
        }
