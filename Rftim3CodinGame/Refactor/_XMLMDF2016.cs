...
{
    public class _XMLMDF2016 : I_XMLMDF2016
    {
        #region Static
        ...
        public _XMLMDF2016()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_XMLMDF2016));
        }
        ...
        public _XMLMDF2016(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_XMLMDF2016));
        }
