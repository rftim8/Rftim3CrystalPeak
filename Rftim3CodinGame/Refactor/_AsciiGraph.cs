...
{
    public class _AsciiGraph : I_AsciiGraph
    {
        #region Static
        ...
        public _AsciiGraph()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_AsciiGraph));
        }
        ...
        public _AsciiGraph(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_AsciiGraph));
        }
