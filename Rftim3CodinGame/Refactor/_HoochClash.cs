...
{
    public class _HoochClash : I_HoochClash
    {
        #region Static
        ...
        public _HoochClash()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_HoochClash));
        }
        ...
        public _HoochClash(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_HoochClash));
        }
