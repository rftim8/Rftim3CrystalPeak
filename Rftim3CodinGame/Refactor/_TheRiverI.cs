...
{
    public class _TheRiverI : I_TheRiverI
    {
        #region Static
        ...
        public _TheRiverI()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TheRiverI));
        }
        ...
        public _TheRiverI(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TheRiverI));
        }
