...
namespace Rftim3CodinGame.Refactor
{
    public class _DAWG : I_DAWG
    {
        ...
        public _DAWG()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_DAWG));
        }
        ...
        public _DAWG(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_DAWG));
        }
