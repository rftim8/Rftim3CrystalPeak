...
{
    public class _KnightsJam : I_KnightsJam
    {
        #region Static
        ...
        public _KnightsJam()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_KnightsJam));
        }
        ...
        public _KnightsJam(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_KnightsJam));
        }
