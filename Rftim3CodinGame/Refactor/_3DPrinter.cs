...
{
    public class _3DPrinter : I_3DPrinter
    {
        #region Static
        ...
        public _3DPrinter()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_3DPrinter));
        }
        ...
        public _3DPrinter(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_3DPrinter));
        }
