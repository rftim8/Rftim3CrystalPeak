...
{
    public class _DDCGMapper : I_DDCGMapper
    {
        #region Static
        ...
        public _DDCGMapper()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_DDCGMapper));
        }
        ...
        public _DDCGMapper(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_DDCGMapper));
        }
