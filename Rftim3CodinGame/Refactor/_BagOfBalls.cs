...
{
    public class _BagOfBalls : I_BagOfBalls
    {
        #region Static
        ...
        public _BagOfBalls()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_BagOfBalls));
        }
        ...
        public _BagOfBalls(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_BagOfBalls));
        }
