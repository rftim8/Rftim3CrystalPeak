...
{
    public class _HanoiTower : I_HanoiTower
    {
        #region Static
        ...
        public _HanoiTower()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_HanoiTower));
        }
        ...
        public _HanoiTower(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_HanoiTower));
        }
