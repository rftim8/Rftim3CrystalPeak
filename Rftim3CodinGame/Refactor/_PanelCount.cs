...
{
    public class _PanelCount : I_PanelCount
    {
        #region Static
        ...
        public _PanelCount()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_PanelCount));
        }
        ...
        public _PanelCount(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_PanelCount));
        }
