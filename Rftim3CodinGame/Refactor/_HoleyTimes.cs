...
{
    public class _HoleyTimes : I_HoleyTimes
    {
        #region Static
        ...
        public _HoleyTimes()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_HoleyTimes));
        }
        ...
        public _HoleyTimes(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_HoleyTimes));
        }
