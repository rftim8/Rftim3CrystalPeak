...
{
    public class _MaxArea : I_MaxArea
    {
        #region Static
        ...
        public _MaxArea()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_MaxArea));
        }
        ...
        public _MaxArea(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_MaxArea));
        }
