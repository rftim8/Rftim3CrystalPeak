...
{
    public class _SHA256Hash : I_SHA256Hash
    {
        #region Static
        ...
        public _SHA256Hash()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_SHA256Hash));
        }
        ...
        public _SHA256Hash(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_SHA256Hash));
        }
