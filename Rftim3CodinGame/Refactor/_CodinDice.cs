...
{
    public class _CodinDice : I_CodinDice
    {
        #region Static
        ...
        public _CodinDice()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_CodinDice));
        }
        ...
        public _CodinDice(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_CodinDice));
        }
