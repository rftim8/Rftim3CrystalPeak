...
{
    public class _NQueens : I_NQueens
    {
        #region Static
        ...
        public _NQueens()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_NQueens));
        }
        ...
        public _NQueens(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_NQueens));
        }
