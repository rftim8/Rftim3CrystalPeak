...
{
    public class _OddQuadOut : I_OddQuadOut
    {
        #region Static
        ...
        public _OddQuadOut()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_OddQuadOut));
        }
        ...
        public _OddQuadOut(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_OddQuadOut));
        }
