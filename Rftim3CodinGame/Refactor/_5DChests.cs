...
{
    public class _5DChests : I_5DChests
    {
        #region Static
        ...
        public _5DChests()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_5DChests));
        }
        ...
        public _5DChests(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_5DChests));
        }
