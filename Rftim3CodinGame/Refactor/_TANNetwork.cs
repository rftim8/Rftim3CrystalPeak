...
{
    public class _TANNetwork : I_TANNetwork
    {
        #region Static
        ...
        public _TANNetwork()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TANNetwork));
        }
        ...
        public _TANNetwork(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TANNetwork));
        }
