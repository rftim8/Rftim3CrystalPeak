...
{
    public class _TheVoucher : I_TheVoucher
    {
        #region Static
        ...
        public _TheVoucher()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_TheVoucher));
        }
        ...
        public _TheVoucher(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_TheVoucher));
        }
