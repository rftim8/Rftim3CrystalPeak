...
{
    public class _Surface : I_Surface
    {
        #region Static
        ...
        public _Surface()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Surface));
        }
        ...
        public _Surface(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Surface));
        }
