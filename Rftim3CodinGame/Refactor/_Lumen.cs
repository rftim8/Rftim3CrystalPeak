...
namespace Rftim3CodinGame.Refactor
{
    public class _Lumen : I_Lumen
    {
        ...
        public _Lumen()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Lumen));
        }
        ...
        public _Lumen(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Lumen));
        }
