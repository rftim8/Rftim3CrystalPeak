...
{
    public class _11puzzle : I_11puzzle
    {
        #region Static
        ...
        public _11puzzle()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_11puzzle));
        }
        ...
        public _11puzzle(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_11puzzle));
        }
