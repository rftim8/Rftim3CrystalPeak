...
namespace Rftim3CodinGame.Refactor
{
    public class _Bingo : I_Bingo
    {
        ...
        public _Bingo()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Bingo));
        }
        ...
        public _Bingo(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Bingo));
        }
