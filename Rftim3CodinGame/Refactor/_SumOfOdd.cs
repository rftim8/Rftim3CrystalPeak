...
{
    public class _SumOfOdd : I_SumOfOdd
    {
        #region Static
        ...
        public _SumOfOdd()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_SumOfOdd));
        }
        ...
        public _SumOfOdd(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_SumOfOdd));
        }
