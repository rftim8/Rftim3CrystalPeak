...
{
    public class _Breakout : I_Breakout
    {
        #region Static
        ...
        public _Breakout()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Breakout));
        }
        ...
        public _Breakout(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Breakout));
        }
