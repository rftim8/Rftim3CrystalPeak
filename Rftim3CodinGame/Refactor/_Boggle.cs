...
namespace Rftim3CodinGame.Refactor
{
    public class _Boggle : I_Boggle
    {
        ...
        public _Boggle()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Boggle));
        }
        ...
        public _Boggle(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Boggle));
        }
