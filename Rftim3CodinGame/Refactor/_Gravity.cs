...
{
    public class _Gravity : I_Gravity
    {
        #region Static
        ...
        public _Gravity()
        {
            data = RftCodinGameStaticData.Input_Test(testType: false, problemName: nameof(_Gravity));
        }
        ...
        public _Gravity(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            data = RftCodinGameHostData.Input_Test(problemName: nameof(_Gravity));
        }
