...
{
    public class RftServiciuDeDateFacturiTelefonie<T> where T : RftModelFacturiTelefonie
    {
        private readonly RftContextGeneratorModel rftContextGeneratorModel;

        public RftServiciuDeDateFacturiTelefonie(RftContextGeneratorModel rftContextGeneratorModel)
        {
