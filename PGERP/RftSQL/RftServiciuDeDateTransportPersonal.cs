...
{
    public class RftServiciuDeDateTransportPersonal<T> where T : RftModelTransportPersonal
    {
        private readonly RftContextGeneratorModel rftContextGeneratorModel;

        public RftServiciuDeDateTransportPersonal(RftContextGeneratorModel rftContextGeneratorModel)
        {
