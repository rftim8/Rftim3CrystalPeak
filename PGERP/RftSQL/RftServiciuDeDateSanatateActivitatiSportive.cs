...
{
    public class RftServiciuDeDateSanatateActivitatiSportive<T> where T : RftModelSanatateActivitatiSportive
    {
        private readonly RftContextGeneratorModel rftContextGeneratorModel;

        public RftServiciuDeDateSanatateActivitatiSportive(RftContextGeneratorModel rftContextGeneratorModel)
        {
