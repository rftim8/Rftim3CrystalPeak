...
{
    public class RftServiciuDeDateDivertismentJocuri<T> where T : RftModelDivertismentJocuri
    {
        private readonly RftContextGeneratorModel rftContextGeneratorModel;

        public RftServiciuDeDateDivertismentJocuri(RftContextGeneratorModel rftContextGeneratorModel)
        {
