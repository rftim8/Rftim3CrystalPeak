...
{
    public class RftServiciuDeDateTransportComun<T> where T : RftModelTransportComun
    {
        private readonly RftContextGeneratorModel rftContextGeneratorModel;

        public RftServiciuDeDateTransportComun(RftContextGeneratorModel rftContextGeneratorModel)
        {
