...
{
    internal class RftComandaExportPDFContinutFacturi : RftComandaBaza
    {
        private readonly RftVedereModelContinutFacturi rftVedereModelContinutFacturi;

        public RftComandaExportPDFContinutFacturi(RftVedereModelContinutFacturi rftVedereModelContinutFacturi)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutFacturi.RftGraficTitlu));
