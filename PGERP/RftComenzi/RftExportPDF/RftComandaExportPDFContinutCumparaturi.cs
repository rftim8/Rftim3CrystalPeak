...
{
    internal class RftComandaExportPDFContinutCumparaturi : RftComandaBaza
    {
        private readonly RftVedereModelContinutCumparaturi rftVedereModelContinutCumparaturi;

        public RftComandaExportPDFContinutCumparaturi(RftVedereModelContinutCumparaturi rftVedereModelContinutCumparaturi)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutCumparaturi.RftGraficTitlu));
