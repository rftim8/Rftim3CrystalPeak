...
{
    internal class RftComandaExportPDFContinutFacturiCurent : RftComandaBaza
    {
        private readonly RftVedereModelContinutCurent rftVedereModelContinutCurent;

        public RftComandaExportPDFContinutFacturiCurent(RftVedereModelContinutCurent rftVedereModelContinutCurent)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutCurent.RftGraficTitlu));
