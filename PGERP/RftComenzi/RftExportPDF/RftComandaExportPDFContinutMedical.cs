...
{
    internal class RftComandaExportPDFContinutMedical : RftComandaBaza
    {
        private readonly RftVedereModelContinutMedical rftVedereModelContinutMedical;

        public RftComandaExportPDFContinutMedical(RftVedereModelContinutMedical rftVedereModelContinutMedical)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutMedical.RftGraficTitlu));
