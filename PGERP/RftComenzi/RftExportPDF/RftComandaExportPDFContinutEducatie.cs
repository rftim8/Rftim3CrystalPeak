...
{
    internal class RftComandaExportPDFContinutEducatie : RftComandaBaza
    {
        private readonly RftVedereModelContinutEducatie rftVedereModelContinutEducatie;

        public RftComandaExportPDFContinutEducatie(RftVedereModelContinutEducatie rftVedereModelContinutEducatie)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutEducatie.RftGraficTitlu));
