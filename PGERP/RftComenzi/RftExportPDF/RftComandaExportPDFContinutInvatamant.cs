...
{
    internal class RftComandaExportPDFContinutInvatamant : RftComandaBaza
    {
        private readonly RftVedereModelContinutInvatamant rftVedereModelContinutInvatamant;

        public RftComandaExportPDFContinutInvatamant(RftVedereModelContinutInvatamant rftVedereModelContinutInvatamant)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutInvatamant.RftGraficTitlu));
