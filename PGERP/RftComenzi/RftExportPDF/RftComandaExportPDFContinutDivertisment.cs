...
{
    internal class RftComandaExportPDFContinutDivertisment : RftComandaBaza
    {
        private readonly RftVedereModelContinutDivertisment rftVedereModelContinutDivertisment;

        public RftComandaExportPDFContinutDivertisment(RftVedereModelContinutDivertisment rftVedereModelContinutDivertisment)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutDivertisment.RftGraficTitlu));
