...
{
    internal class RftComandaExportPDFContinutTransportPersonal : RftComandaBaza
    {
        private readonly RftVedereModelContinutPersonal rftVedereModelContinutPersonal;

        public RftComandaExportPDFContinutTransportPersonal(RftVedereModelContinutPersonal rftVedereModelContinutPersonal)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutPersonal.RftGraficTitlu));
