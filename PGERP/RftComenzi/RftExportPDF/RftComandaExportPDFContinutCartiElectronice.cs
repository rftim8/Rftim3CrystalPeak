...
{
    internal class RftComandaExportPDFContinutCartiElectronice : RftComandaBaza
    {
        private readonly RftVedereModelContinutCartiElectronice rftVedereModelContinutCartiElectronice;

        public RftComandaExportPDFContinutCartiElectronice(RftVedereModelContinutCartiElectronice rftVedereModelContinutCartiElectronice)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutCartiElectronice.RftGraficTitlu));
