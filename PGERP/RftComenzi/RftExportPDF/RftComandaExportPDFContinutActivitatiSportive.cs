...
{
    internal class RftComandaExportPDFContinutActivitatiSportive : RftComandaBaza
    {
        private readonly RftVedereModelContinutActivitatiSportive rftVedereModelContinutActivitatiSportive;

        public RftComandaExportPDFContinutActivitatiSportive(RftVedereModelContinutActivitatiSportive rftVedereModelContinutActivitatiSportive)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutActivitatiSportive.RftGraficTitlu));
