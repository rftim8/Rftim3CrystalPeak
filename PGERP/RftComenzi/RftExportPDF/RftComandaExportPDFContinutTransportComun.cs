...
{
    internal class RftComandaExportPDFContinutTransportComun : RftComandaBaza
    {
        private readonly RftVedereModelContinutComun rftVedereModelContinutComun;

        public RftComandaExportPDFContinutTransportComun(RftVedereModelContinutComun rftVedereModelContinutComun)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutComun.RftGraficTitlu));
