...
{
    internal class RftComandaExportPDFContinutImbracaminte : RftComandaBaza
    {
        private readonly RftVedereModelContinutImbracaminte rftVedereModelContinutImbracaminte;

        public RftComandaExportPDFContinutImbracaminte(RftVedereModelContinutImbracaminte rftVedereModelContinutImbracaminte)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutImbracaminte.RftGraficTitlu));
