...
{
    internal class RftComandaExportPDFContinutElectronice : RftComandaBaza
    {
        private readonly RftVedereModelContinutElectronice rftVedereModelContinutElectronice;

        public RftComandaExportPDFContinutElectronice(RftVedereModelContinutElectronice rftVedereModelContinutElectronice)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutElectronice.RftGraficTitlu));
