...
{
    internal class RftComandaExportPDFContinutTransport : RftComandaBaza
    {
        private readonly RftVedereModelContinutTransport rftVedereModelContinutTransport;

        public RftComandaExportPDFContinutTransport(RftVedereModelContinutTransport rftVedereModelContinutTransport)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutTransport.RftGraficTitlu));
