...
{
    internal class RftComandaExportPDFContinutSanatate : RftComandaBaza
    {
        private readonly RftVedereModelContinutSanatate rftVedereModelContinutSanatate;

        public RftComandaExportPDFContinutSanatate(RftVedereModelContinutSanatate rftVedereModelContinutSanatate)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutSanatate.RftGraficTitlu));
