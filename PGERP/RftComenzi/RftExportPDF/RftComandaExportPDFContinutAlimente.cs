...
{
    internal class RftComandaExportPDFContinutAlimente : RftComandaBaza
    {
        private readonly RftVedereModelContinutAlimente rftVedereModelContinutAlimente;

        public RftComandaExportPDFContinutAlimente(RftVedereModelContinutAlimente rftVedereModelContinutAlimente)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutAlimente.RftGraficTitlu));
