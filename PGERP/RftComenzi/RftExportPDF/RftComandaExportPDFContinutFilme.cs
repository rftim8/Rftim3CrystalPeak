...
{
    internal class RftComandaExportPDFContinutFilme : RftComandaBaza
    {
        private readonly RftVedereModelContinutFilme rftVedereModelContinutFilme;

        public RftComandaExportPDFContinutFilme(RftVedereModelContinutFilme rftVedereModelContinutFilme)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutFilme.RftGraficTitlu));
