...
{
    internal class RftComandaExportPDFContinutMuzica : RftComandaBaza
    {
        private readonly RftVedereModelContinutMuzica rftVedereModelContinutMuzica;

        public RftComandaExportPDFContinutMuzica(RftVedereModelContinutMuzica rftVedereModelContinutMuzica)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutMuzica.RftGraficTitlu));
