...
{
    internal class RftComandaExportPDFContinutFacturiApa : RftComandaBaza
    {
        private readonly RftVedereModelContinutApa rftVedereModelContinutApa;

        public RftComandaExportPDFContinutFacturiApa(RftVedereModelContinutApa rftVedereModelContinutApa)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutApa.RftGraficTitlu));
