...
{
    internal class RftComandaExportPDFContinutTelefonie : RftComandaBaza
    {
        private readonly RftVedereModelContinutTelefonie rftVedereModelContinutTelefonie;

        public RftComandaExportPDFContinutTelefonie(RftVedereModelContinutTelefonie rftVedereModelContinutTelefonie)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                rftTabelaTotal.AddCell(new Phrase(rftVedereModelContinutTelefonie.RftGraficTitlu));
