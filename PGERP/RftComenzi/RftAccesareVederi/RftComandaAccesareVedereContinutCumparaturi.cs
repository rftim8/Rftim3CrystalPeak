...
{
    internal class RftComandaAccesareVedereContinutCumparaturi : RftComandaBaza
    {
        ...
        public RftComandaAccesareVedereContinutCumparaturi(RftVedereModelContinut rftVedereModelContinut,
        ...
        {
            rftVedereModelContinut.RftVedereModelContinutActual = rftVedereModelContinut.rftVedereModelContinutCumparaturi;
            rftVedereModelMeniuStanga.RftVedereModelMeniuStangaCurent = new RftVedereModelMeniuStangaCumparaturi(rftVedereModelContinut);
            rftVedereModelFereastraPrincipala.RftTextCategorieCurenta = "Cumparaturi";
        }
    }
}
