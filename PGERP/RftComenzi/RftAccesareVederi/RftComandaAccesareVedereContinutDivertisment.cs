...
{
    internal class RftComandaAccesareVedereContinutDivertisment : RftComandaBaza
    {
        ...
        public RftComandaAccesareVedereContinutDivertisment(RftVedereModelContinut rftVedereModelContinut,
        ...
        {
            rftVedereModelContinut.RftVedereModelContinutActual = rftVedereModelContinut.rftVedereModelContinutDivertisment;
            rftVedereModelMeniuStanga.RftVedereModelMeniuStangaCurent = new RftVedereModelMeniuStangaDivertisment(rftVedereModelContinut);
            rftVedereModelFereastraPrincipala.RftTextCategorieCurenta = "Divertisment";
        }
    }
}
