...
{
    internal class RftComandaExportCSVContinutFacturiApa : RftComandaBaza
    {
        private readonly RftVedereModelContinutApa rftVedereModelContinutApa;

        public RftComandaExportCSVContinutFacturiApa(RftVedereModelContinutApa rftVedereModelContinutApa)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelFacturiApa>? rftDateDeExport = rftVedereModelContinutApa.RftModelFacturiApaLista.ToList();
                DataTable rftTabelaDeDate = new(typeof(RftModelFacturiApa).Name);
                PropertyInfo[] rftModelProprietati = typeof(RftModelFacturiApa).GetProperties(BindingFlags.Public | BindingFlags.Instance);
                ...
                foreach (RftModelFacturiApa? item in rftDateDeExport)
                {
                ...
                stringBuilder.Append(rftVedereModelContinutApa.RftGraficTitlu + Environment.NewLine);
