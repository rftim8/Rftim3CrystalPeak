...
{
    internal class RftComandaExportCSVContinutPrincipal : RftComandaBaza
    {
        private readonly RftVedereModelContinutPrincipala rftVedereModelContinutPrincipala;

        public RftComandaExportCSVContinutPrincipal(RftVedereModelContinutPrincipala rftVedereModelContinutPrincipala)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                stringBuilder.Append(rftVedereModelContinutPrincipala.RftGraficTitlu + Environment.NewLine);
