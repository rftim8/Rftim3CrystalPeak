...
{
    internal class RftComandaExportCSVContinutJocuri : RftComandaBaza
    {
        private readonly RftVedereModelContinutJocuri rftVedereModelContinutJocuri;

        public RftComandaExportCSVContinutJocuri(RftVedereModelContinutJocuri rftVedereModelContinutJocuri)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                stringBuilder.Append(rftVedereModelContinutJocuri.RftGraficTitlu + Environment.NewLine);
