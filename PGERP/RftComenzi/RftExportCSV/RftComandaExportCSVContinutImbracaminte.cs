...
{
    internal class RftComandaExportCSVContinutImbracaminte : RftComandaBaza
    {
        private readonly RftVedereModelContinutImbracaminte rftVedereModelContinutImbracaminte;

        public RftComandaExportCSVContinutImbracaminte(RftVedereModelContinutImbracaminte rftVedereModelContinutImbracaminte)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelCumparaturiImbracaminte>? rftDateDeExport = rftVedereModelContinutImbracaminte.RftModelCumparaturiImbracaminteLista.ToList();
                DataTable rftTabelaDeDate = new(typeof(RftModelCumparaturiImbracaminte).Name);
                PropertyInfo[] rftModelProprietati = typeof(RftModelCumparaturiImbracaminte).GetProperties(BindingFlags.Public | BindingFlags.Instance);
                ...
                foreach (RftModelCumparaturiImbracaminte? item in rftDateDeExport)
                {
                ...
                stringBuilder.Append(rftVedereModelContinutImbracaminte.RftGraficTitlu + Environment.NewLine);
