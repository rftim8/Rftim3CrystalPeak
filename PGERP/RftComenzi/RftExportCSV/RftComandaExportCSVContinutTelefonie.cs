...
{
    internal class RftComandaExportCSVContinutTelefonie : RftComandaBaza
    {
        private readonly RftVedereModelContinutTelefonie rftVedereModelContinutTelefonie;

        public RftComandaExportCSVContinutTelefonie(RftVedereModelContinutTelefonie rftVedereModelContinutTelefonie)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                stringBuilder.Append(rftVedereModelContinutTelefonie.RftGraficTitlu + Environment.NewLine);
