...
{
    internal class RftComandaExportCSVContinutDivertisment : RftComandaBaza
    {
        private readonly RftVedereModelContinutDivertisment rftVedereModelContinutDivertisment;

        public RftComandaExportCSVContinutDivertisment(RftVedereModelContinutDivertisment rftVedereModelContinutDivertisment)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelTranzactieGeneralTabela>? rftDateDeExport = rftVedereModelContinutDivertisment.RftModelTranzactieGeneralTabelaLista.ToList();
                ...
                stringBuilder.Append(rftVedereModelContinutDivertisment.RftGraficTitlu + Environment.NewLine);
