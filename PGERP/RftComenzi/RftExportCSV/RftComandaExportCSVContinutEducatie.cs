...
{
    internal class RftComandaExportCSVContinutEducatie : RftComandaBaza
    {
        private readonly RftVedereModelContinutEducatie rftVedereModelContinutEducatie;

        public RftComandaExportCSVContinutEducatie(RftVedereModelContinutEducatie rftVedereModelContinutEducatie)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelTranzactieGeneralTabela>? rftDateDeExport = rftVedereModelContinutEducatie.RftModelTranzactieGeneralTabelaLista.ToList();
                ...
                stringBuilder.Append(rftVedereModelContinutEducatie.RftGraficTitlu + Environment.NewLine);
