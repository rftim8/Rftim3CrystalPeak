...
{
    internal class RftComandaExportCSVContinutAlimente : RftComandaBaza
    {
        private readonly RftVedereModelContinutAlimente rftVedereModelContinutAlimente;

        public RftComandaExportCSVContinutAlimente(RftVedereModelContinutAlimente rftVedereModelContinutAlimente)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelCumparaturiAlimente>? rftDateDeExport = rftVedereModelContinutAlimente.RftModelCumparaturiAlimenteLista.ToList();
                DataTable rftTabelaDeDate = new(typeof(RftModelCumparaturiAlimente).Name);
                PropertyInfo[] rftModelProprietati = typeof(RftModelCumparaturiAlimente).GetProperties(BindingFlags.Public | BindingFlags.Instance);
                ...
                foreach (RftModelCumparaturiAlimente? item in rftDateDeExport)
                {
                ...
                stringBuilder.Append(rftVedereModelContinutAlimente.RftGraficTitlu + Environment.NewLine);
