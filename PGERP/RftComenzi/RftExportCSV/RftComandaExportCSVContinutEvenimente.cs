...
{
    internal class RftComandaExportCSVContinutEvenimente : RftComandaBaza
    {
        private readonly RftVedereModelContinutEvenimente rftVedereModelContinutEvenimente;

        public RftComandaExportCSVContinutEvenimente(RftVedereModelContinutEvenimente rftVedereModelContinutEvenimente)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                stringBuilder.Append(rftVedereModelContinutEvenimente.RftGraficTitlu + Environment.NewLine);
