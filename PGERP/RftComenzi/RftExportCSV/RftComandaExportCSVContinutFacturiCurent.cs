...
{
    internal class RftComandaExportCSVContinutFacturiCurent : RftComandaBaza
    {
        private readonly RftVedereModelContinutCurent rftVedereModelContinutCurent;

        public RftComandaExportCSVContinutFacturiCurent(RftVedereModelContinutCurent rftVedereModelContinutCurent)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelFacturiCurent>? rftDateDeExport = rftVedereModelContinutCurent.RftModelFacturiCurentLista.ToList();
                DataTable rftTabelaDeDate = new(typeof(RftModelFacturiCurent).Name);
                PropertyInfo[] rftModelProprietati = typeof(RftModelFacturiCurent).GetProperties(BindingFlags.Public | BindingFlags.Instance);
                ...
                foreach (RftModelFacturiCurent? item in rftDateDeExport)
                {
                ...
                stringBuilder.Append(rftVedereModelContinutCurent.RftGraficTitlu + Environment.NewLine);
