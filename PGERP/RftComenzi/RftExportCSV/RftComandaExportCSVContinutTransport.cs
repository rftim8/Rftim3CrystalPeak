...
{
    internal class RftComandaExportCSVContinutTransport : RftComandaBaza
    {
        private readonly RftVedereModelContinutTransport rftVedereModelContinutTransport;

        public RftComandaExportCSVContinutTransport(RftVedereModelContinutTransport rftVedereModelContinutTransport)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelTranzactieGeneralTabela>? rftDateDeExport = rftVedereModelContinutTransport.RftModelTranzactieGeneralTabelaLista.ToList();
                ...
                stringBuilder.Append(rftVedereModelContinutTransport.RftGraficTitlu + Environment.NewLine);
