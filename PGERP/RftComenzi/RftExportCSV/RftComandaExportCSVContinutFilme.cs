...
{
    internal class RftComandaExportCSVContinutFilme : RftComandaBaza
    {
        private readonly RftVedereModelContinutFilme rftVedereModelContinutFilme;

        public RftComandaExportCSVContinutFilme(RftVedereModelContinutFilme rftVedereModelContinutFilme)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelDivertismentFilme>? rftDateDeExport = rftVedereModelContinutFilme.RftModelDivertismentFilmeLista.ToList();
                DataTable rftTabelaDeDate = new(typeof(RftModelDivertismentFilme).Name);
                PropertyInfo[] rftModelProprietati = typeof(RftModelDivertismentFilme).GetProperties(BindingFlags.Public | BindingFlags.Instance);
                ...
                foreach (RftModelDivertismentFilme? item in rftDateDeExport)
                {
                ...
                stringBuilder.Append(rftVedereModelContinutFilme.RftGraficTitlu + Environment.NewLine);
