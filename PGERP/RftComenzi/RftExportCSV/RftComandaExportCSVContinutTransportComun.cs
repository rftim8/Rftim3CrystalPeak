...
{
    internal class RftComandaExportCSVContinutTransportComun : RftComandaBaza
    {
        private readonly RftVedereModelContinutComun rftVedereModelContinutComun;

        public RftComandaExportCSVContinutTransportComun(RftVedereModelContinutComun rftVedereModelContinutComun)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelTransportComun>? rftDateDeExport = rftVedereModelContinutComun.RftModelTransportComunLista.ToList();
                DataTable rftTabelaDeDate = new(typeof(RftModelTransportComun).Name);
                PropertyInfo[] rftModelProprietati = typeof(RftModelTransportComun).GetProperties(BindingFlags.Public | BindingFlags.Instance);
                ...
                foreach (RftModelTransportComun? item in rftDateDeExport)
                {
                ...
                stringBuilder.Append(rftVedereModelContinutComun.RftGraficTitlu + Environment.NewLine);
