...
{
    internal class RftComandaExportCSVContinutMuzica : RftComandaBaza
    {
        private readonly RftVedereModelContinutMuzica rftVedereModelContinutMuzica;

        public RftComandaExportCSVContinutMuzica(RftVedereModelContinutMuzica rftVedereModelContinutMuzica)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                stringBuilder.Append(rftVedereModelContinutMuzica.RftGraficTitlu + Environment.NewLine);
