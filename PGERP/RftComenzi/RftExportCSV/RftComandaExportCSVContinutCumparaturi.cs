...
{
    internal class RftComandaExportCSVContinutCumparaturi : RftComandaBaza
    {
        private readonly RftVedereModelContinutCumparaturi rftVedereModelContinutCumparaturi;

        public RftComandaExportCSVContinutCumparaturi(RftVedereModelContinutCumparaturi rftVedereModelContinutCumparaturi)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelTranzactieGeneralTabela>? rftDateDeExport = rftVedereModelContinutCumparaturi.RftModelTranzactieGeneralTabelaLista.ToList();
                ...
                stringBuilder.Append(rftVedereModelContinutCumparaturi.RftGraficTitlu + Environment.NewLine);
