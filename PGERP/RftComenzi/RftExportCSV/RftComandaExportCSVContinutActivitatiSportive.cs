...
{
    internal class RftComandaExportCSVContinutActivitatiSportive : RftComandaBaza
    {
        private readonly RftVedereModelContinutActivitatiSportive rftVedereModelContinutActivitatiSportive;

        public RftComandaExportCSVContinutActivitatiSportive(RftVedereModelContinutActivitatiSportive rftVedereModelContinutActivitatiSportive)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelSanatateActivitatiSportive>? rftDateDeExport = rftVedereModelContinutActivitatiSportive.RftModelSanatateActivitatiSportiveLista.ToList();
                DataTable rftTabelaDeDate = new(typeof(RftModelSanatateActivitatiSportive).Name);
                PropertyInfo[] rftModelProprietati = typeof(RftModelSanatateActivitatiSportive).GetProperties(BindingFlags.Public | BindingFlags.Instance);
                ...
                foreach (RftModelSanatateActivitatiSportive? item in rftDateDeExport)
                {
                ...
                stringBuilder.Append(rftVedereModelContinutActivitatiSportive.RftGraficTitlu + Environment.NewLine);
