...
{
    internal class RftComandaExportCSVContinutSanatate : RftComandaBaza
    {
        private readonly RftVedereModelContinutSanatate rftVedereModelContinutSanatate;

        public RftComandaExportCSVContinutSanatate(RftVedereModelContinutSanatate rftVedereModelContinutSanatate)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelTranzactieGeneralTabela>? rftDateDeExport = rftVedereModelContinutSanatate.RftModelTranzactieGeneralTabelaLista.ToList();
                ...
                stringBuilder.Append(rftVedereModelContinutSanatate.RftGraficTitlu + Environment.NewLine);
