...
{
    internal class RftComandaExportCSVContinutFacturi : RftComandaBaza
    {
        private readonly RftVedereModelContinutFacturi rftVedereModelContinutFacturi;

        public RftComandaExportCSVContinutFacturi(RftVedereModelContinutFacturi rftVedereModelContinutFacturi)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                List<RftModelTranzactieGeneralTabela>? rftDateDeExport = rftVedereModelContinutFacturi.RftModelTranzactieGeneralTabelaLista.ToList();
                ...
                stringBuilder.Append(rftVedereModelContinutFacturi.RftGraficTitlu + Environment.NewLine);
