...
{
    internal class RftComandaSetareBugetApa : RftComandaBaza
    {
        ...
        public RftComandaSetareBugetApa(RftVedereModelContinut rftVedereModelContinut)
        {
        ...
        public override async void Execute(object? parameter)
        {
            ...
            if (!decimal.TryParse(rftVedereModelContinut.RftBugetApaTemporar, out decimal rftBugetApaTemporar))
            {
            ...
            if (!decimal.TryParse(rftVedereModelContinut.RftBugetApaActual, out decimal rftBugetApaActual))
            {
                rftVedereModelContinut.RftMesajEroare = RftMesajePredefinite.RftEroareFormatBugetGresit;
                return;
            }
            ...
            if (rftBugetApaTemporar < -RftGeneral.RftBugetMaxim)
            {
            ...
            if (rftBugetApaTemporar > rftBugetNealocatActual)
            {
                rftVedereModelContinut.RftMesajEroare = RftMesajePredefinite.RftEroareBugetNealocatDepasit;
                return;
            }

            if (rftBugetApaActual + rftBugetApaTemporar < 0)
            {
                rftVedereModelContinut.RftMesajEroare = RftMesajePredefinite.RftEroareBugetIndisponibil;
                return;
            }

            if (rftBugetApaTemporar.ToString("0.00") != rftBugetApaTemporar.ToString() &&
                rftBugetApaTemporar.ToString("0.0") != rftBugetApaTemporar.ToString() &&
                rftBugetApaTemporar.ToString("0") != rftBugetApaTemporar.ToString())
            {
                rftVedereModelContinut.RftMesajEroare = RftMesajePredefinite.RftEroareFormatBugetGresit;
                return;
            }
            ...
            if (rftBugetApaActual.ToString("0.00") != rftBugetApaActual.ToString() &&
                rftBugetApaActual.ToString("0.0") != rftBugetApaActual.ToString() &&
                rftBugetApaActual.ToString("0") != rftBugetApaActual.ToString())
            {
                rftVedereModelContinut.RftMesajEroare = RftMesajePredefinite.RftEroareFormatBugetGresit;
                return;
            }
            ...
            rftBugetNealocatActual -= rftBugetApaTemporar;
            rftBugetApaActual += rftBugetApaTemporar;
            rftBugetFacturiActual += rftBugetApaTemporar;
            rftBugetTotalActual += rftBugetApaTemporar;

            rftVedereModelContinut.RftBugetNealocatActual = rftBugetNealocatActual.ToString();
            rftVedereModelContinut.RftBugetApaActual = rftBugetApaActual.ToString();
            ...
            rftVedereModelContinut.RftBugetApaTemporar = rftBugetApaTemporar.ToString();

            RftModelBuget x = rftServiciuDeDateBuget.RftReturnareObiectId(1).Result;
            x.Nealocat = rftBugetNealocatActual;
            x.FacturiApa = rftBugetApaActual;
