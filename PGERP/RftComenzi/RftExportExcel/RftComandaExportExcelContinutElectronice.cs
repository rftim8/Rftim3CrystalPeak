...
{
    internal class RftComandaExportExcelContinutElectronice : RftComandaBaza
    {
        private readonly RftVedereModelContinutElectronice rftVedereModelContinutElectronice;

        public RftComandaExportExcelContinutElectronice(RftVedereModelContinutElectronice rftVedereModelContinutElectronice)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutElectronice.RftGraficTitlu;
