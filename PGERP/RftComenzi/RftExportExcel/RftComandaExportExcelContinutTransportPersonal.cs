...
{
    internal class RftComandaExportExcelContinutTransportPersonal : RftComandaBaza
    {
        private readonly RftVedereModelContinutPersonal rftVedereModelContinutPersonal;

        public RftComandaExportExcelContinutTransportPersonal(RftVedereModelContinutPersonal rftVedereModelContinutPersonal)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutPersonal.RftGraficTitlu;
