...
{
    internal class RftComandaExportExcelContinutTransportComun : RftComandaBaza
    {
        private readonly RftVedereModelContinutComun rftVedereModelContinutComun;

        public RftComandaExportExcelContinutTransportComun(RftVedereModelContinutComun rftVedereModelContinutComun)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutComun.RftGraficTitlu;
