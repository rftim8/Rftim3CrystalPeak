...
{
    internal class RftComandaExportExcelContinutPrincipal : RftComandaBaza
    {
        private readonly RftVedereModelContinutPrincipala rftVedereModelContinutPrincipala;

        public RftComandaExportExcelContinutPrincipal(RftVedereModelContinutPrincipala rftVedereModelContinutPrincipala)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutPrincipala.RftGraficTitlu;
