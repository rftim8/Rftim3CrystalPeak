...
{
    internal class RftComandaExportExcelContinutTransport : RftComandaBaza
    {
        private readonly RftVedereModelContinutTransport rftVedereModelContinutTransport;

        public RftComandaExportExcelContinutTransport(RftVedereModelContinutTransport rftVedereModelContinutTransport)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutTransport.RftGraficTitlu;
