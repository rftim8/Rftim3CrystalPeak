...
{
    internal class RftComandaExportExcelContinutFacturi : RftComandaBaza
    {
        private readonly RftVedereModelContinutFacturi rftVedereModelContinutFacturi;

        public RftComandaExportExcelContinutFacturi(RftVedereModelContinutFacturi rftVedereModelContinutFacturi)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutFacturi.RftGraficTitlu;
