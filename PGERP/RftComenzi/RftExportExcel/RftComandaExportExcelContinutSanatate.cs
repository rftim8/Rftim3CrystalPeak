...
{
    internal class RftComandaExportExcelContinutSanatate : RftComandaBaza
    {
        private readonly RftVedereModelContinutSanatate rftVedereModelContinutSanatate;

        public RftComandaExportExcelContinutSanatate(RftVedereModelContinutSanatate rftVedereModelContinutSanatate)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutSanatate.RftGraficTitlu;
