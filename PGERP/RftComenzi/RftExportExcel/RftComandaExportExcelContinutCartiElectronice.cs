...
{
    internal class RftComandaExportExcelContinutCartiElectronice : RftComandaBaza
    {
        private readonly RftVedereModelContinutCartiElectronice rftVedereModelContinutCartiElectronice;

        public RftComandaExportExcelContinutCartiElectronice(RftVedereModelContinutCartiElectronice rftVedereModelContinutCartiElectronice)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutCartiElectronice.RftGraficTitlu;
