...
{
    internal class RftComandaExportExcelContinutEducatie : RftComandaBaza
    {
        private readonly RftVedereModelContinutEducatie rftVedereModelContinutEducatie;

        public RftComandaExportExcelContinutEducatie(RftVedereModelContinutEducatie rftVedereModelContinutEducatie)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutEducatie.RftGraficTitlu;
