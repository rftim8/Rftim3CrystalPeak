...
{
    internal class RftComandaExportExcelContinutEvenimente : RftComandaBaza
    {
        private readonly RftVedereModelContinutEvenimente rftVedereModelContinutEvenimente;

        public RftComandaExportExcelContinutEvenimente(RftVedereModelContinutEvenimente rftVedereModelContinutEvenimente)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutEvenimente.RftGraficTitlu;
