...
{
    internal class RftComandaExportExcelContinutActivitatiSportive : RftComandaBaza
    {
        private readonly RftVedereModelContinutActivitatiSportive rftVedereModelContinutActivitatiSportive;

        public RftComandaExportExcelContinutActivitatiSportive(RftVedereModelContinutActivitatiSportive rftVedereModelContinutActivitatiSportive)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutActivitatiSportive.RftGraficTitlu;
