...
{
    internal class RftComandaExportExcelContinutJocuri : RftComandaBaza
    {
        private readonly RftVedereModelContinutJocuri rftVedereModelContinutJocuri;

        public RftComandaExportExcelContinutJocuri(RftVedereModelContinutJocuri rftVedereModelContinutJocuri)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutJocuri.RftGraficTitlu;
