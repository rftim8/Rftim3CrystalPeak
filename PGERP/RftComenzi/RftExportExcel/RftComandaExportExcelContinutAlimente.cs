...
{
    internal class RftComandaExportExcelContinutAlimente : RftComandaBaza
    {
        private readonly RftVedereModelContinutAlimente rftVedereModelContinutAlimente;

        public RftComandaExportExcelContinutAlimente(RftVedereModelContinutAlimente rftVedereModelContinutAlimente)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutAlimente.RftGraficTitlu;
