...
{
    internal class RftComandaExportExcelContinutFacturiApa : RftComandaBaza
    {
        private readonly RftVedereModelContinutApa rftVedereModelContinutApa;

        public RftComandaExportExcelContinutFacturiApa(RftVedereModelContinutApa rftVedereModelContinutApa)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutApa.RftGraficTitlu;
