...
{
    internal class RftComandaExportExcelContinutDivertisment : RftComandaBaza
    {
        private readonly RftVedereModelContinutDivertisment rftVedereModelContinutDivertisment;

        public RftComandaExportExcelContinutDivertisment(RftVedereModelContinutDivertisment rftVedereModelContinutDivertisment)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutDivertisment.RftGraficTitlu;
