...
{
    internal class RftComandaExportExcelContinutMedical : RftComandaBaza
    {
        private readonly RftVedereModelContinutMedical rftVedereModelContinutMedical;

        public RftComandaExportExcelContinutMedical(RftVedereModelContinutMedical rftVedereModelContinutMedical)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutMedical.RftGraficTitlu;
