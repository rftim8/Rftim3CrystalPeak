...
{
    internal class RftComandaExportExcelContinutImbracaminte : RftComandaBaza
    {
        private readonly RftVedereModelContinutImbracaminte rftVedereModelContinutImbracaminte;

        public RftComandaExportExcelContinutImbracaminte(RftVedereModelContinutImbracaminte rftVedereModelContinutImbracaminte)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutImbracaminte.RftGraficTitlu;
