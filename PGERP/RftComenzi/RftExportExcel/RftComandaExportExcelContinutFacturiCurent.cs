...
{
    internal class RftComandaExportExcelContinutFacturiCurent : RftComandaBaza
    {
        private readonly RftVedereModelContinutCurent rftVedereModelContinutCurent;

        public RftComandaExportExcelContinutFacturiCurent(RftVedereModelContinutCurent rftVedereModelContinutCurent)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutCurent.RftGraficTitlu;
