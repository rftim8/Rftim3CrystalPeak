...
{
    internal class RftComandaExportExcelContinutCumparaturi : RftComandaBaza
    {
        private readonly RftVedereModelContinutCumparaturi rftVedereModelContinutCumparaturi;

        public RftComandaExportExcelContinutCumparaturi(RftVedereModelContinutCumparaturi rftVedereModelContinutCumparaturi)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutCumparaturi.RftGraficTitlu;
