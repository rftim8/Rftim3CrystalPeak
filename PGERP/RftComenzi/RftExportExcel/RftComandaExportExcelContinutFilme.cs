...
{
    internal class RftComandaExportExcelContinutFilme : RftComandaBaza
    {
        private readonly RftVedereModelContinutFilme rftVedereModelContinutFilme;

        public RftComandaExportExcelContinutFilme(RftVedereModelContinutFilme rftVedereModelContinutFilme)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutFilme.RftGraficTitlu;
