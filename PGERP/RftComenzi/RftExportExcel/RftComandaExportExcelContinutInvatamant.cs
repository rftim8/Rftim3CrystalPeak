...
{
    internal class RftComandaExportExcelContinutInvatamant : RftComandaBaza
    {
        private readonly RftVedereModelContinutInvatamant rftVedereModelContinutInvatamant;

        public RftComandaExportExcelContinutInvatamant(RftVedereModelContinutInvatamant rftVedereModelContinutInvatamant)
        {
        ...
        public override void Execute(object? parameter)
        {
            ...
            if (rftSalvareDocument.FileName != "")
            {
                ...
                try
                {
                    ...
                    excelWorksheet.Cells[1, 1] = rftVedereModelContinutInvatamant.RftGraficTitlu;
